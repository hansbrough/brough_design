        ...
        <Container>
          ...
          <div className={styles.section}>
            <div className={styles.subSection}>
              ...
              <p>
                As a general rule the design costs will run about 10% of the total project cost for larger projects up to roughly 25% for smaller projects.
                Smaller projects usually include just a portion of the property and need just a limited set of construction documents like a planting plan and calling out semi-permanent hardscape such as dry laid flagtone paths or low dry stack walls.
            ...
            <div className={styles.subSection}>
              ...
              <p>
                Yes, we can definately help find plants through our own licensed nursery or buying wholesale from other nurseries.
                We will sell plants to your licensed landscape contractor at a 15% discount.
              </p>
            </div>
          </div>
        </Container>
